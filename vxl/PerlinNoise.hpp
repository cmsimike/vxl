///
/// Perlin Noise implementation written by Kazade (Luke Benstead)
/// Which was found on (http://blog.kazade.co.uk/2014/05/a-public-domain-c11-1d2d3d-perlin-noise.html)
///
#pragma once
